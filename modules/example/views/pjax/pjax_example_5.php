...
<h1>Отправка данных на сервер с помощью Pjax методом POST (Yii2)</h1>

<a href="/blog/post/use-pjax-widget-in-yii2-with-examples#pjax-example-5">&larr; вернуться к статье</a>
